...
const QString BITCOIN_IPC_PREFIX("levcoin:");

static QString ipcServerName()
{
    QString name("Levcoin");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start levcoin: click-to-pay handler");
    else
...
{
    // clicking on levcoin: URLs creates FileOpen events on the Mac:
